...
export const LoginView: React.FC<LoginViewProps> = ({ onLoginSuccess, storeName = '鑫蘴家' }) => {
        ...
        <div className="relative flex h-screen w-full flex-col justify-center items-center overflow-hidden bg-[#221910] font-sans">
            ...
            <div className="relative z-10 w-full max-w-[480px] px-6 flex flex-col items-center">
                <div className="mb-10 text-center">
                    ...
                    <h2 className="text-[#f27f0d] text-lg font-bold tracking-[0.3em] uppercase mb-2">{storeName}</h2>
