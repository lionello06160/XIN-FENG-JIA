...
這是一個專為頂級私廚 **主廚 Rolando** 打造的高級感官饗宴展示網站。本專案整合了現代化的前端設計與強大的後端管理功能，旨在為顧客提供沉浸式的線上訂餐與資訊瀏覽體驗。
...
### 📊 主廚強效後台
- **內容管理系統 (CMS)**：主廚可即時更新菜色、價格、食材、靈感故事及供應狀態，並能一鍵切換菜色於首頁的可見性。
...
- **帳號安全**：具備管理員權限驗證與密碼變更功能，並實施嚴格的資料庫 RLS (Row Level Security) 驗證策略，防止惡意資料寫入，保障後台數據安全。
